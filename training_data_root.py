"""
Training / split data root: same layout as repo's default ``training data/`` (dataset_split.json,
``outdoor/``, ``indoor/``, etc.).
...
def get_training_data_root():
    ...
    return os.path.normpath(
        os.path.join(os.path.dirname(os.path.abspath(__file__)), "training data")
    )
